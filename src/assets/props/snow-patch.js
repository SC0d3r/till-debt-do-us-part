...
// ─── Palette (snow ramp) ───
const SNOW = { light: 0xffffff, mid: 0xeaf1f8, dark: 0xb4c6d8, outline: 0x7e93ad }
...
function getGeometry() {
  if (!geometry) {
    ...
    for (const dr of drifts) {
      ...
      // drift reads flat against the snow tile.
      shadeFaces(g, SNOW, { aoAmount: 0.5, hi: 0.7, lo: 0.05 })
