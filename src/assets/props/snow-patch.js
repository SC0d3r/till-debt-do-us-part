...
function getGeometry() {
  if (!geometry) {
    const parts = []
    const drifts = [
      { r: 0.055, jitter: 0.18, squash: 0.44, seed: 877, off: [-0.02, 0.02] },
      { r: 0.05, jitter: 0.18, squash: 0.44, seed: 878, off: [0.05, 0.01] },
      { r: 0.042, jitter: 0.2, squash: 0.46, seed: 879, off: [-0.05, -0.025] },
      { r: 0.035, jitter: 0.18, squash: 0.44, seed: 880, off: [0.01, -0.055] },
    ]
