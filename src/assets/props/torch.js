...
function getGeometry() {
  if (!geometry) {
    ...
    const flame = buildFlame({ r: 0.02, h: 0.085, y0: POST_H - 0.012, lean: 0.14, tones: FLAME, sides: 5 })
    parts.push(flame)
    // Contact ring.
    parts.push(buildContactRing({ r: 0.03, color: WOOD.outline, thickness: 0.018 }))
