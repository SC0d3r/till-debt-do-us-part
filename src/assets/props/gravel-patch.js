...
function getGeometry() {
  if (!geometry) {
    ...
    const mounds = [
      { r: 0.05, jitter: 0.18, squash: 0.3, seed: 801, off: [-0.035, 0.02] },
      { r: 0.04, jitter: 0.18, squash: 0.3, seed: 802, off: [0.045, -0.02] },
    ]
    ...
    // Pebble scatter.
    const pebbles = [
      { r: 0.034, jitter: 0.5, squash: 0.62, seed: 811, off: [-0.02, -0.045], tan: true },
      { r: 0.03, jitter: 0.55, squash: 0.64, seed: 812, off: [0.03, 0.045], tan: false },
      { r: 0.027, jitter: 0.5, squash: 0.62, seed: 813, off: [-0.055, -0.005], tan: false },
      { r: 0.025, jitter: 0.55, squash: 0.66, seed: 814, off: [0.055, 0.012], tan: true },
      { r: 0.023, jitter: 0.5, squash: 0.62, seed: 815, off: [0.0, 0.055], tan: false },
      { r: 0.021, jitter: 0.6, squash: 0.62, seed: 816, off: [-0.045, 0.045], tan: false },
      { r: 0.02, jitter: 0.55, squash: 0.66, seed: 817, off: [0.045, -0.05], tan: false },
    ]
