 ...
 *     through it — see transitionTexture.js; the WHITE_UV math consumers use
 *     is unchanged).
 ...
 *     helper, re-exported from transitionTexture.js (logic reused verbatim,
 ...
 *     same pipeline transitionTexture.js uses (module docs, point 6).
 *
 * Textures are 32x32 (TRANSITION_TEXTURE_SIZE — pinned for all top faces, so
 * plain tiles and transition zippers stay visually consistent).
 */

import * as THREE from 'three'
import { SeededRNG } from '../../core/procedural'
import { maskDiamondEdge } from '../tiles/transitionTexture'
 ...
 * through it — keep the WHITE_UV math from transitionTexture.js; never draw
