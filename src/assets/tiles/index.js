 ...
 *
 * Importing this module pulls in all five families (grass, water, sand, lava,
 * snow). Family modules remain importable directly for their color constants.
 */
...
export const FAMILIES = [grass, water, sand, lava, snow]
...
/** All variant names, in family order (grass first, then water/sand/lava/snow). */
