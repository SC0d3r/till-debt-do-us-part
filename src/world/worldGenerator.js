 ...
 *      max(|x|,|y|) <= SPAWN_PIN_RADIUS (2) — is pinned solid in isTileSolid:
 *      the player always spawns on a comfortable grass island, never a
 *      one-tile spike in the void (seeds 777/4242/1/2 booted to 1-16 tiles
 *      pre-fix). Tiles beyond the patch follow the island noise, so the
 *      patch edge stays ragged where the noise is void.
