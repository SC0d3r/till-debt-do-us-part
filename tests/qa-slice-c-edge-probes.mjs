 ...
 *  (simulates the dev clicking the canvas). Guard-specific probes (P8j)
 *  deliberately do NOT blur before their keys. */
...
section('P7. Window resize mid-game (camera + renderer survive)')
{
  ...
  // Move after resize: WASD still drives the player (input listeners
  // survive). Completion round: the fixture's overlay input holds focus and
  // the typing guard swallows WASD — blur it first so the movement is real.
