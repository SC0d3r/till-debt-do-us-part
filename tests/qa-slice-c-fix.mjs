...
//       sparse connectors for seeds 1337/777/4242 and the field is
//       deterministic across re-generation. NOTE: the round-2 spawn patch
//       (5×5 fully-solid grass island, isTileSolid pin) legitimately absorbed
//       one of seed 777's stones — ground truth is now iso=[4,1,6], so 777
//       is asserted at >= 1 while 1337/4242 stay at >= 2.
...
section('S3. Stepping stones: sparse isolated connectors (3 seeds)')
{
  ...
  test('S3a isolated stepping-stone tiles exist (1337 >= 2, 777 >= 1, 4242 >= 2 — post spawn-patch ground truth [4,1,6])',
    r.ok && counts[0] >= 2 && counts[2] >= 1 && counts[4] >= 2,
